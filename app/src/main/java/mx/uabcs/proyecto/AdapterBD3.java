...
public class AdapterBD3 extends SQLiteOpenHelper {

    public static final String TABLE_ID="idNote3";
    public static final String TITLE="title3";
    public static final String CONTENT="content3";

    public static final String DATABASE="idNote3";
    public static final String TABLE="idNote3";


    public AdapterBD3(Context context) {
