...
public class NoteActivity3 extends AppCompatActivity {
    ...
    public void actividad(String act) {
        ...
        if (act.equals("add")) {
            ...
            type = "add";
            Intent intent = new Intent(NoteActivity3.this, AgregarNota3.class);
            ...
            if (act.equals("edit")) {
                ...
                if(act.equals("see")){
                    content = getNote();
                    Intent intent = new Intent(NoteActivity3.this, VerNota3.class);
                    intent.putExtra("title",getTitle);
                    intent.putExtra("content",content);
                    startActivity(intent);
