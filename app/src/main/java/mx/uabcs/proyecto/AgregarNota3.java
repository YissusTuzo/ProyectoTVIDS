...
public class AgregarNota3 extends AppCompatActivity {
    Button Add;
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (id){
            ...
            case SALIR:
                ...
                Intent intent = new Intent(AgregarNota3.this, NoteActivity3.class);
            ...
            if(type.equals("edit")){
                ...
                if(title.equals("")){
                    ...
                    if (content.equals("")){
                        ...
                        DB1.updateNote(title,content,getTitle);
                        actividad(title,content);
                    }
                }
            }
    ...
    public void actividad(String title, String content){
        ...
        Intent intent= new Intent(AgregarNota3.this,VerNota3.class);
