...
public class AgregarNota1 extends AppCompatActivity {
    Button Add;
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (id){
            ...
            case SALIR:
                ...
                Intent intent = new Intent(AgregarNota1.this, NoteActivity1.class);
    ...
    public void actividad(String title, String content){
        ...
        Intent intent= new Intent(AgregarNota1.this,VerNota1.class);
