...
public class VerNota3 extends AppCompatActivity {
    ...
    public void actividad(String f){
        ...
        if(f.equals("edit")){
            String type = "edit";
            Intent intent = new Intent(VerNota3.this,AgregarNota3.class);
            ...
            if(f.equals("delete")){
                ...
                Intent intent = new Intent(VerNota3.this, NoteActivity3.class);
