...
public class VerNota1 extends AppCompatActivity {
    ...
    public void actividad(String f){
        ...
        if(f.equals("edit")){
            String type = "edit";
            Intent intent = new Intent(VerNota1.this,AgregarNota1.class);
            ...
            if(f.equals("delete")){
                ...
                Intent intent = new Intent(VerNota1.this, NoteActivity1.class);
