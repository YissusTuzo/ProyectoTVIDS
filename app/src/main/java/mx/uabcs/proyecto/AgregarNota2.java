...
public class AgregarNota2 extends AppCompatActivity {
    Button Add;
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (id){
            ...
            case SALIR:
                ...
                Intent intent = new Intent(AgregarNota2.this, NoteActivity2.class);
    ...
    public void actividad(String title, String content){
        ...
        Intent intent= new Intent(AgregarNota2.this,VerNota2.class);
