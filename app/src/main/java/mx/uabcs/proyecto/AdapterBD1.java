...
public class AdapterBD1 extends SQLiteOpenHelper {

    public static final String TABLE_ID="idNote1";
    public static final String TITLE="title1";
    public static final String CONTENT="content1";

    public static final String DATABASE="idNote1";
    public static final String TABLE="idNote1";


    public AdapterBD1(Context context) {
